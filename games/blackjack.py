...
class Blackjack(CreditGame):
    ...
    class BlackjackView(View):
        ...
        def _make_buttons(self):
            ...
            button_funcs     = [base_cog.hit, base_cog.stand, base_cog.double, base_cog.split]
            button_labels    = ["Hit", "Stand", "Double", "Split"]
            button_styles    = [ButtonStyle.green, ButtonStyle.red, ButtonStyle.blurple, ButtonStyle.grey]
